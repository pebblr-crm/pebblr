...
/* Extracted body to reduce cognitive complexity of the main component. */

interface ActivityDetailBodyProps {
  readonly activity: NonNullable<ReturnType<typeof useActivity>['data']>
  readonly statusLabel: string
  readonly selectedType: { fields: Array<{ key: string }>; category?: string } | undefined
  readonly submitRequired: Set<string>
  readonly isLocked: boolean
  readonly feedback: string
  readonly promotedProducts: string[]
  readonly productOptions: Array<{ key: string; label: string }>
  readonly getFieldError: (field: string) => string | undefined
  readonly onFeedbackChange: (value: string) => void
  readonly onToggleProduct: (key: string) => void
}

function ActivityDetailBody({
  activity, statusLabel, selectedType, submitRequired, isLocked,
  feedback, promotedProducts, productOptions, getFieldError,
  onFeedbackChange, onToggleProduct,
