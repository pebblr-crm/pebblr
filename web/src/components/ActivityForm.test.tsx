...
describe('ActivityForm', () => {
  ...
  it('renders the form with core fields', () => {
    render(
  ...
  it('sets initial status from config', () => {
    render(
      <ActivityForm onSubmit={onSubmit} onCancel={onCancel} isSubmitting={false} />,
    )
  ...
  it('shows routing options from config', () => {
    render(
      <ActivityForm onSubmit={onSubmit} onCancel={onCancel} isSubmitting={false} />,
    )

    expect(screen.getByTestId('routing-select')).toBeInTheDocument()
