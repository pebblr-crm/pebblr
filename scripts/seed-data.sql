...
INSERT INTO activities (id, activity_type, status, due_date, duration, routing, fields, target_id, creator_id, joint_visit_user_id, team_id, submitted_at, created_at) VALUES
  ...
  ('d0000000-0000-0000-0000-000000000001', 'visit', 'completed',
   CURRENT_DATE - INTERVAL '7 days', '', 'week_1',
   '{"visit_type": "f2f", "promoted_products": ["product_1"], "feedback": "Good reception, doctor interested in new cardiology line.", "details": "Discussed Q2 samples."}',
  ...
  ('d0000000-0000-0000-0000-000000000002', 'visit', 'completed',
   CURRENT_DATE - INTERVAL '5 days', '', 'week_1',
   '{"visit_type": "f2f", "promoted_products": ["product_1"], "feedback": "Needs follow-up on dosage info.", "details": "Quick check-in, left brochures."}',
  ...
  ('d0000000-0000-0000-0000-000000000003', 'visit', 'planned',
   CURRENT_DATE + INTERVAL '1 day', '', 'week_2',
   '{"visit_type": "f2f"}',
   'c0000000-0000-0000-0000-000000000001',
   'a0000000-0000-0000-0000-000000000004', NULL,
   'b0000000-0000-0000-0000-000000000001',
  ...
  ('d0000000-0000-0000-0000-000000000004', 'visit', 'completed',
   CURRENT_DATE - INTERVAL '3 days', '', 'week_1',
   '{"visit_type": "f2f", "promoted_products": ["product_1"], "feedback": "Family medicine doc very receptive, requested samples.", "details": "Presented new product line."}',
  ...
  ('d0000000-0000-0000-0000-000000000005', 'visit', 'planned',
   CURRENT_DATE + INTERVAL '2 days', '', 'week_2',
   '{"visit_type": "remote"}',
  ...
  ('d0000000-0000-0000-0000-000000000006', 'visit', 'planned',
   CURRENT_DATE + INTERVAL '3 days', '', 'week_2',
   '{"visit_type": "f2f"}',
  ...
  ('d0000000-0000-0000-0000-000000000007', 'visit', 'completed',
   CURRENT_DATE - INTERVAL '6 days', '', 'week_1',
   '{"visit_type": "f2f", "promoted_products": ["product_1"], "feedback": "Neurology specialist interested, scheduled follow-up.", "details": "Detailed product presentation."}',
  ...
  ('d0000000-0000-0000-0000-000000000008', 'visit', 'cancelled',
   CURRENT_DATE - INTERVAL '2 days', '', 'week_1',
   '{"visit_type": "f2f"}',
  ...
  ('d0000000-0000-0000-0000-000000000010', 'visit', 'completed',
   CURRENT_DATE - INTERVAL '4 days', '', 'week_1',
   '{"visit_type": "f2f", "promoted_products": ["product_1"], "feedback": "Discussed pulmonology treatments, positive outlook.", "details": "On-site visit with Dr. Georgescu."}',
  ...
  ('d0000000-0000-0000-0000-000000000011', 'visit', 'planned',
   CURRENT_DATE + INTERVAL '4 days', '', 'week_2',
   '{"visit_type": "remote"}',
  ...
  ('d0000000-0000-0000-0000-000000000012', 'visit', 'planned',
   CURRENT_DATE + INTERVAL '5 days', '', 'week_2',
   '{"visit_type": "f2f"}',
