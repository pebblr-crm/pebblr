...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_activities_creator_not_deleted
    ON activities(creator_id) WHERE deleted_at IS NULL;

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_activities_target_not_deleted
    ON activities(target_id) WHERE deleted_at IS NULL;

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_activities_due_date_not_deleted
    ON activities(due_date) WHERE deleted_at IS NULL;

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_activities_status_not_deleted
    ON activities(status) WHERE deleted_at IS NULL;

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_activities_team_not_deleted
    ON activities(team_id) WHERE deleted_at IS NULL;

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_activities_type_not_deleted
